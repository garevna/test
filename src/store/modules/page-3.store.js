...
const state = {
  ...
  top: {
    header: 'Melbourne’s Fastest Fibre Broadband Now Available In The Aurora: All Residents Get Their 1st Month For Free',
    text: 'Now that Pineapple Fibre is in the Aurora building, residents can connect to unlimited, ultra-fast, FTTH internet. Long overdue, full-fibre will supercharge your home internet, unlock lightspeed downloads, and uploads that are just as fast. Experience Melbourne’s juiciest home internet. Your first month’s on us.',
    button: 'Get in Touch',
    goto: '#contact',
    pictureURL: 'https://api.pineapple.net.au/images/aurora-2.jpg'
  },
  testimonials: {
  ...
  info: {
    header: 'Fibre From $50, Speeds up to 1000mbps',
    text: 'Pineapple Fibre connects directly to your home. No copper. No compromise, just rock-solid fibre all the way. You’ll enjoy internet, so reliable that you forget where the modem is. So fast that a 5GB movie download only takes only a couple minutes.<br>Breakneck speeds and flawless stream.  With fibre, everything is better. Your video conferences. Your 4K Netflix. All in crisp real-time. No buffering. No annoying frame-rate drops. That’s the power of fibre.',
    offer: [
      {
